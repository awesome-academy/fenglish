		...
		<div class="md-col-8">
			<fieldset>
					...
					<tbody>
						<c:forEach items="${listUsers}" var="user">
							<tr>
								...
								<td>${user.birthday}</td>
								<td>Yes</td>
								<td><spring:url value="/admin/user/${user.id}/detail"
										var="detailActionUrl" />
									<button class="btn btn-info"
										onclick="location.href='${detailActionUrl}'">Chi tiết</button>
									<spring:url value="/admin/user/${user.id}/delete" var="deleteActionUrl" />
				...
				<tag:paginate offset="${offset}" count="${count}"
					uri="${pageContext.request.contextPath}/admin/listUsers"
