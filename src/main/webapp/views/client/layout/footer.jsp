					...
					<div class="newsletter_form_container mx-auto">
						<form action="post">
							<div
								...
								<input id="newsletter_email" class="newsletter_email"
									type="email" placeholder="Địa chỉ Email..." required="required"
		...
		<div class="footer_content">
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					...
					<p class="footer_about_text">In aliquam, augue a gravida
						rutrum, ante nisl fermentum nulla, vitae tempor nisl ligula vel
						nunc. Proin quis mi malesuada, finibus tortor fermentum, tempor
						lacus.</p>
